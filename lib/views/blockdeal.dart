...
class BlockDealTab extends StatefulWidget {
  const BlockDealTab({Key? key}) : super(key: key);

  @override
  _BlockDealTabState createState() => _BlockDealTabState();
}

class _BlockDealTabState extends State<BlockDealTab> {
  final dataBloc = ApiHandlerBloc();

  @override
  void initState() {
    dataBloc.dealEventSink.add(DealAction.Block);
